...
class ControllerCatalogCategory extends Controller { 
	...
	if (isset($this->request->get['filter_product_count'])) {
		$filter_product_count = html_entity_decode(
			$this->request->get['filter_product_count'],
			ENT_QUOTES,
			'UTF-8'
		);
	...
	$this->data['column_parent_category'] = 'Parent Category';
	...
	$this->data['sort_name'] = $this->url->link(
		'catalog/category',
		'token=' . $this->session->data['token'] . '&sort=name' . $url,
		'SSL'
	);

	$this->data['sort_product_count'] = $this->url->link(
		'catalog/category',
		'token=' . $this->session->data['token'] . '&sort=product_count' . $url,
		'SSL'
	);

	$this->data['sort_sort_order'] = $this->url->link(
		'catalog/category',
		'token=' . $this->session->data['token'] . '&sort=sort_order' . $url,
		'SSL'
	);
