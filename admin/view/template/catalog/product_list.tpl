        ...
        <table class="list">
            ...
            <tr>
              ...
              <td class="left"><?php if ($sort == 'p.price') { ?>
                ...
                <td class="left"><?php if ($sort == 'p.cost') { ?>
                    <a href="<?php echo $sort_cost; ?>" class="<?php echo strtolower($order); ?>">
                        <?php echo $column_cost; ?>
                    </a>
                <?php } else { ?>
                    <a href="<?php echo $sort_cost; ?>">
                        <?php echo $column_cost; ?>
                    </a>
                <?php } ?></td>
                <td class="left">
          ...
          <tbody>
            <tr class="filter">
              ...
              <select name="filter_category">
                ...
                <?php foreach ($filter_categories as $category) { ?>
                  <option value="<?php echo $category['category_id']; ?>"
                    <?php if ($category['category_id'] == $filter_category) echo 'selected="selected"'; ?>>
              ...
              <td><input type="text" name="filter_cost"value="<?php echo htmlspecialchars_decode($filter_cost); ?>"placeholder="> 100" /></td>
             <td> <input type="text" name="filter_profit"value="<?php echo htmlspecialchars_decode($filter_profit); ?>"placeholder="> 20" /></td>
            ...
            <tr>
              ...
              <td class="left"><?php if (!empty($product['categories'])) { ?><?php foreach ($product['categories'] as $category) { ?><div><?php echo $category; ?></div><?php } ?><?php } ?></td>
