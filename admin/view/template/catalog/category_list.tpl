        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php echo $column_parent_category; ?></td>
              <td class="right" style="width:150px"><?php echo $column_sort_order; ?></td>
              <td class="right"><?php if ($sort == 'product_count') { ?><a href="<?php echo $sort_product_count; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_product_count; ?></a><?php } else { ?><a href="<?php echo $sort_product_count; ?>"><?php echo $column_product_count; ?></a><?php } ?></td>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td class="right"><input type="text" name="filter_product_count"value="<?php echo $filter_product_count; ?>"/></td>
